...
from prompt_base import INSTRUCTION_TWENTY_QUESTIONS
...
class TwentyQuestionsEnv():
    def __init__(
        ...
        self.model.load_state_dict(torch.load("20q_t5_oracle.pt")['model_state_dict'])
    ...
    def _step(self, question):
        ...
        # answer = llm_deepseek(prompt=question_instruction, model="deepseek-reasoner")
